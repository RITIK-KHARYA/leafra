            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    data = results.matches
                        .filter(function (match) { return match.score !== undefined && match.score > thresholdvalue; })
                        .map(function (match) {
                        var _a;
                        var content = (_a = match.metadata) === null || _a === void 0 ? void 0 : _a.content;
                        return typeof content === "string" ? content : "";
                    })
                        .filter(function (content) { return content.length > 0; })
                        .join("\n\n");
                    if (!data) {
                        return [2 /*return*/, "No results found"];
                    }
                    else {
                        logger_1.logger.debug("Pinecone query results", { results: results, data: data });
