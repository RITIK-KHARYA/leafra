      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">
            Transform how you interact with PDF documents using AI-powered
            analysis
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-300">
              Upload PDF documents up to 8MB and let our AI process them
              automatically for instant analysis.
            </p>
          </div>
          ...
          <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-300">
              Vector-based search ensures you get relevant information from your
          ...
          <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-300">
              Your documents are encrypted and processed securely. We prioritize
          ...
          <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-300">
              Get instant responses with real-time streaming, perfect for
              long-form answers and detailed explanations.
            </p>
          </div>
          ...
          <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-300">
              Sign in with your preferred method - email/password or social
              accounts (Google, GitHub, Discord).
            </p>
          </div>
        </div>
