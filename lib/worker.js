...
var worker = new bullmq_1.Worker("upload-pdf", function (job) { return __awaiter(void 0, void 0, void 0, function () {
    var fileUrl_1, response, buffer, blob, loader, rawDocs, splitter, docs, docsPromise, docsWithVectors, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, embeddings.embedQuery(doc.pageContent.replace(/\n/g, ""))];
            ...
            case 5:
                ...
                return [4 /*yield*/, pineconeIndex.upsert(docsWithVectors)];
            case 6:
                _a.sent();
