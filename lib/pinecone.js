...
function getResultFromQuery(query) {
    return __awaiter(this, void 0, void 0, function () {
        var pinecone, index, embeddedQuery, results, data;
...
function getAnswers(query) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("http://localhost:3000/api/chat", {
                        method: "POST",
                        headers: {
...
getAnswers("who is ritik and what is his hobby? and rate his resume based on his projects");
