...
if (!process.env.UPSTASH_REDIS_REST_URL ||
    ...
    console.warn("Redis environment variables are not set. Redis functionality will be limited.");
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, redis.set("test", "test")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, redis.get("test")];
                case 2:
                    result = _a.sent();
                    return [4 /*yield*/, redis.del("test")];
                case 3:
                    _a.sent();
                    return [2 /*return*/, result === "test"];
                case 4:
                    error_1 = _a.sent();
